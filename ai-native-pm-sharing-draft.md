...
---
# 16. 分享 Slides 初步结构（30 页展示版 / 40 页备稿版）

> 这部分只是从本文抽取的演讲骨架，不是最终逐字稿。当前 HTML 展示版建议控制在 **30 页 / 60 分钟**：投屏内容少，重点靠口播强调观点、非共识和个人判断；下面的 40 页结构作为扩展备稿和后续 Slidev 版本参考。
...
| Prompt → Harness → Loop | 17–24 | 20 分钟 |
| Builder / Hackathon / Toolkit | 25–28 | 10 分钟 |
| 行动清单与 Closing | 29–30 | 5 分钟 |
...
| 22 | 控制论：目标、反馈、调节 | PM 对决策负责，必须设计反馈和纠偏 |
| 23 | 信号论：信息接收与验证系统 | 壁垒不是拥有更多信息，而是识别、验证和使用信号 |
| 24 | 一个需求分析 Loop | 信号进入、AI 处理、PM 判断、验证、记录、更新 |
| 25 | 为什么 PM 必须成为 Builder | 当 Demo 成本下降，PM 不能只做需求传递者 |
| 26 | AI-Native PM 五阶段 | 从 AI User 到 Builder & Loop Owner |
| 27 | Hackathon：从表达者到创造者 | 36 小时把 PM 推到对可运行结果负责的位置 |
| 28 | GitHub Toolkit：可复制的 PM Workbench | 每个 PM 都可以复制自己的 Context、Skills、Loops、Builder Starters |
| 29 | 7 天 PM 自进化挑战 | 先跑一条小而真实的闭环 |
| 30 | Closing：PM 对决策负责 | 不要只使用 AI，开始设计共同进化的系统 |
...
4. 全套控制在 28–32 页，目标演讲时间 60 分钟；复杂资料放入 Speaker Notes、GitHub Toolkit 或附录，不挤进投屏页。
...
9. Loop 的九部件环形图；
10. Signal→Research→Frame→Options→Build→Evaluate→Decide→Learn 工作流；
11. Hackathon I-D-E-A-S 评分卡与 36 小时时间轴；
12. `rainnochen/ai_native_pm_sharing` 仓库结构与十分钟 Quick Start。
...
以底稿第 16 章的 30 页展示版大纲为基础。允许为了节奏合并或拆分 2 页，但不得改变故事线：
